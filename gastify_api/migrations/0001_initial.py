    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forma_pagamento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gastify_api.forma_pagamento')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gastify_api.usuario')),
            ],
        ),
    ]
